...
class Institutestd (models.Model):
    ...
    ch_no = models.CharField(max_length=64,null=True)
    dop = models.DateField(null=True)
    application = models.BinaryField(null=True)
    undertake = models.BinaryField(null=True)
    recipt = models.BinaryField(null=True)
    afd = models.BinaryField(null=True)
